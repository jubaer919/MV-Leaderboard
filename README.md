...
Leaderboard! project is a repository consisting of the following files:
- HTML file 
- CSS file 
- JS files
...
## Leaderboard - [HTML/CSS & JavaScript Leaderboard project](https://github.com/microverseinc/curriculum-javascript/blob/main/books/m2_plain_js_classes_v1_1.md)
### Features Added:
- Create a colection of name and number
- Create a function to add a new task to the collection. from the api
- Create a function to refresh the collection 
- Display all tasks saved in the collection from the api.
